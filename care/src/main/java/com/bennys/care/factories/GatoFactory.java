...
public class GatoFactory {
    ...
    public static List<Gato> gerar(Integer quantidade) {
        ...
        List<String> especies = new ArrayList<String>(Arrays.asList("Persa", "Siamês", "Sphynx", "Siberiano", "Ragdoll"));
        ...
        for (int i = 0; i < quantidade; i++) {
            ...
            gato.setEspecie(especies.get(random.nextInt(especies.size())));
